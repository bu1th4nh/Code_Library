...
% \*==========================================================================================*/
% 
%   LaTeX Report Template v2.07 by bu1th4nh. Copyright (c) 2022 bu1th4nh. All right reserved
...
\usepackage{setspace}
\usepackage{parskip}
\usepackage{minted} % Cho phép chèn code
...
\counterwithin{figure}{section} % Đánh số hình ảnh kèm theo section. Ví dụ: Hình 1.1, 1.2,..
