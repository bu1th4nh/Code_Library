...
% \*==========================================================================================*/
% 
%   LaTeX HUST Project Template v2.06 by bu1th4nh. Copyright (c) 2022 bu1th4nh. All right reserved
...
% Tránh tràn dòng với liên kết, 2.0
\usepackage{url}
\def\UrlBreaks{\do\/\do-}


% Cài đặt số cột tối đa
...
% Tài liệu tham khảo
\usepackage[sorting=none,maxnames=99,giveninits=true,doi=true,url=true,block=ragged]{biblatex}
